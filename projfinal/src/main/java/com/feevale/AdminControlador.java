...
public class AdminControlador {
    ...
    @FXML
    private TextArea textoAtendimentos;
    ...
    private void avancarStatus() {
        TotemAtendimento primeiroAtendimento = admin.getPrimeiroAtendimentoAtivo();
        if (primeiroAtendimento != null) {
            ...
            admin.avancarStatusPrimeiroAtendimento();
    ...
    private void atualizarTextArea() {
        ...
        // Atendimentos ATIVOS (não entregues)
        ...
        if (atendimentosAtivos.isEmpty()) {
            ...
            for (int i = 0; i < atendimentosAtivos.size(); i++) {
                ...
                // Destaca o primeiro atendimento (próximo a ser preparado)
                if (i == 0) {
                ...
                info.append("Valor: R$ ").append(formatarValor(atendimento.getValorTotal())).append("\n");
        ...
        ArrayList<TotemAtendimento> todosAtendimentos = admin.getAtendimentos();
        ...
        textoAtendimentos.setText(info.toString());
    }
