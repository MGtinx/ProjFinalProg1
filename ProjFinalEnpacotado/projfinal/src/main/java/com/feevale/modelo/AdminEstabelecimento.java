...
public class AdminEstabelecimento {
    ...
    private ArrayList<TotemAtendimento> listaAtendimentos = new ArrayList<TotemAtendimento>(); //um p/ a lista toda
    private ArrayList<TotemAtendimento> atendimentosAtivos = new ArrayList<TotemAtendimento>(); //outro p/ os q nãop estão entregues
